...
// import '../assets/style.css'; // <-- Pastikan file CSS utama di-import di sini
...
function DashboardPage() {
    ...
    const [filterStatus, setFilterStatus] = useState(user?.role_id === 3 ? 'Disetujui' : ''); // BPD default lihat Disetujui
    ...
    const fetchData = async () => {
        try {
            ...
            const [statsResponse, tanahResponse] = await Promise.all([
                getStats(),
                getTanahList(currentPage, statusToFetch, searchTerm),
            ]);
